...
export function RegistrarEventoModal({ isOpen, onClose, onEventSaved, parcelas, zafras, cultivos }: RegistrarEventoModalProps) {
  ...
  return (
    <Dialog modal={false} open={isOpen} onOpenChange={onClose}>
      <DialogContent draggable className="h-screen max-h-screen w-screen max-w-full rounded-none p-0 sm:h-auto sm:max-h-[90vh] sm:w-auto sm:max-w-2xl sm:rounded-lg">
